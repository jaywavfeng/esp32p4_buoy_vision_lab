...
#define YOLO26_ESPDL_MAX_DETECTIONS 8
#define YOLO26_ESPDL_NMS_THRESHOLD_X100 70
...
typedef struct {
    ...
    int32_t w;
    int32_t h;
} yolo26_espdl_detection_t;

typedef struct {
    bool has_candidate;
    uint32_t raw_candidate_count;
    uint32_t detection_count;
    yolo26_espdl_detection_t detections[YOLO26_ESPDL_MAX_DETECTIONS];
    uint32_t class_id;
    uint32_t score;
    char label[24];
    int32_t x;
